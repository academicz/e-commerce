...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2021 at 11:37 AM
...
(75, 'sandal', '20', '12', 1, 'product-featured-75.jpeg', '<p>sample product</p>', '<p>shoes</p>', '<p>nothing</p>', '<p>nothing</p>', '<p>no return</p>', 0, 1, 0, 4);
...
--
ALTER TABLE `tbl_product_photo`
  MODIFY `pp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
